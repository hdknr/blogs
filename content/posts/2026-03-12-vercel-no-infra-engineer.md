...
OpenShiftは企業がKubernetesを「利用する」ためのプラットフォームだ。一方、Vercelが構築しているのはKubernetesよりさらに下のレイヤー——microVMレベルからの独自コンピュート基盤である。「基盤を作れるエンジニア」とは、まさにこのレベルの設計・実装ができる人材を指している。
