...
| 平均時価総額 | 適用開始 |
| --- | --- |
| 3 兆円以上 | 2027 年 3 月 31 日以後に終了する事業年度の有価証券報告書等から |
| 3 兆円未満 1 兆円以上 | 2028 年 3 月 31 日以後に終了する事業年度の有価証券報告書等から |
| 1 兆円未満（5,000 億円以上を含む） | 未定（今後検討） |

平均時価総額は 2026 年 3 月 31 日を基準として算定した 5 事業年度末の平均値で判定する。上場後 5 年未満の企業は上場日を含む事業年度の期末日から算定する。

注意点が 2 つある。

1. **5,000 億円以上の区分とそれ以外のプライム上場企業の適用時期は、まだ決まっていない。** 公開草案では「適用対象とすることについて今後検討」とされ、今回の改正には入っていない。2030 年代を目途に全プライム上場企業へ拡大する方向は示されているが、具体的な時期は未定である
2. **保証（アシュアランス）は今回の改正に織り込まれていない。** 中間論点整理では適用義務化の翌年から保証を義務づける方向が示されているが、制度としては別途整備される
...
- 義務化は 2027 年 3 月期・平均時価総額 3 兆円以上から。1 兆円未満の区分と保証はまだ制度未確定
