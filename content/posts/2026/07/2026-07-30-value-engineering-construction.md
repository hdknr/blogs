---
title: "VE（バリューエンジニアリング）とは — 価値＝機能÷コストで考える改善手法と設計VE・入札時VE・契約後VE"
date: 2026-07-30
lastmod: 2026-07-30
slug: "value-engineering-construction"
description: "VE（バリューエンジニアリング）とは何かを「価値＝機能÷コスト」の式から解説。CD（コストダウン）との違い、5原則と3基本ステップ／10詳細ステップ、信号機LED化の事例、建設業の設計VE・入札時VE・契約後VEの使い分けまで。"
draft: false
source_url: "https://github.com/hdknr/blogs/issues/72#issuecomment-5127117316"
categories: ["ビジネス/キャリア"]
tags: ["VE", "バリューエンジニアリング", "建設", "公共工事", "ライフサイクルコスト"]
---

「もっと安く、でも品質は落とさずに」という要求は、どの業界でも日常的に飛んでくる。多くの場合これは矛盾した無理難題として扱われるが、この矛盾を正面から手順化した管理技術がある。

**VE（Value Engineering：バリューエンジニアリング）とは、価値を「機能 ÷ コスト」として捉え、機能を落とさずに価値を高めるための体系化された手法である。** 核心は、コストを削るのではなく機能とコストの比を上げるという発想の切り替えにある。1947 年に生まれた古い手法だが、公益社団法人日本バリューエンジニアリング協会（SJVE）の定義はいまでも過不足がない。
