...
Goose の **Recipes** は Claude Code の Skills に相当し、繰り返しワークフローをコマンド化できます。[Knowledge Graph Memory 拡張](https://goose-docs.ai/docs/tutorials/knowledge-graph-mcp/)でセッション間の記憶も永続化でき、Claude Code の memory.md に近い体験が得られます。
...
- [Goose Knowledge Graph Memory 拡張](https://goose-docs.ai/docs/tutorials/knowledge-graph-mcp/)
