...
[ハーネスエンジニアリング](/blogs/posts/2026/03/harness-engineering/)の文脈で見ると、Code Review は**検証層**の強力なツールとなる。従来のリンターやフォーマッターが「決定論的に検出可能な問題」を扱うのに対し、Code Review は「文脈を理解した上でのバグ検出」という、これまで人間にしかできなかった領域をカバーする。
