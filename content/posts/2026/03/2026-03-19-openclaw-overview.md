...
![OpenClaw Gateway Architecture](/blogs/images/openclaw-gateway-architecture.svg)
...
![Gateway → Agent Runtime → 実行エンジンの流れ](/blogs/images/openclaw-gateway-runtime-flow.png)
...
![OpenClaw 3ステップフロー](/blogs/images/openclaw-3step-flow.png)
...
- [Claude Managed Agents のアーキテクチャ: Brain / Session / Hands の分離設計](/blogs/posts/2026/04/claude-managed-agents-architecture/) — Anthropic が提供するマネージドエージェント基盤のアーキテクチャ解説。OpenClaw との設計思想の比較も掲載
