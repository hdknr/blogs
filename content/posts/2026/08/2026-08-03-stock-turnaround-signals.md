...
なお前提として、銘柄分類そのものの整理は「グロース株・バリュー株・シクリカル株の違い — 銘柄分類 5 つの軸を 1 枚の地図にする」という別記事にまとめている。分類軸は 1 本ではなく、投資スタイル・景気連動性・成長フェーズ・企業規模・テーマの 5 本があるという話だ。この記事はその続きにあたるが、単独で読めるようには書いてある。
