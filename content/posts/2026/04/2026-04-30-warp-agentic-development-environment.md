...
「クライアント本体は OSS、AI クラウド基盤は有償 SaaS」というハイブリッド戦略は、AGPL v3 で競合の SaaS フォークを抑止しつつ、自社の AI バックエンドで収益化するという [SUSE/Open Core](https://en.wikipedia.org/wiki/Open-core_model) 系の現代的アレンジといえます。最新の料金とクレジット消費の詳細は [warp.dev/pricing](https://www.warp.dev/pricing) で確認できます。
