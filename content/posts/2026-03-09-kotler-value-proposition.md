...
| 価値の種類 | Relevance（関連性） | Benefit（便益） | Urgency（緊急性） | 補強ポイント |
|-----------|:------------------:|:--------------:|:----------------:|------------|
| 1. 切実な不満の解消 | **◎** 自明 | **◎** 直接的 | **◎** 痛みが続く限り高い | — （自然に揃う） |
| 2. 自己実現 | **◎** 憧れ | **◎** 成長 | **△** 「いつか」になりがち | Urgency の演出が鍵 |
| 3. 物語 | **◎→** 入口を広げる | **○** 間接的 | **○** 没入で持続 | Relevance を創出する装置 |
| 4. 信頼 | **↑** 判断を省略 | **↑** 疑いを除去 | **↑** 受容を加速 | 全要素を増幅するレバレッジ |

```
  価値の種類        Relevance    Benefit     Urgency
  ─────────────────────────────────────────────────
  1. 不満の解消      ◎───────────◎───────────◎   ← 3要素が自然に揃う
  2. 自己実現        ◎───────────◎───────────△   ← Urgency を補強
  3. 物語            ◎→ 入口を広げる                ← Relevance を創出
  4. 信頼            ↑           ↑           ↑   ← 全要素を増幅
```
